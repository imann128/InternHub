// Small shared SVG icon set — keeps the app's icon language (inline SVG,
// matches the sidebar/nav icons) consistent instead of falling back to
// emoji glyphs, which render inconsistently across OS/browser fonts and
// don't match the design system's line-icon look.
...
export const WarningIcon = ({ size = 14 }) => (
...
export const MegaphoneIcon = ({ size = 14 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ verticalAlign: 'middle' }}>
...
export const WifiOffIcon = ({ size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
